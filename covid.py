...
date  = "20200708"   # data dos dados da análise 
date1 = "20200707"  # data dos dados da última análise 
...
R0_est_dif_0 , R0_est_dif_1 = painel.R0dif(R_smooth4,dR_smooth4,d2R_smooth4,Popul,gamma1,gamma2,alpha)
R0_est_int_0 , R0_est_int_1 = painel.R0int(R_smooth2,dR_smooth2,Popul,gamma1,gamma2,alpha)
...
painel.drawCA(R_raw,R_smooth4,regstr,regfile,date)
painel.drawNC(dR_raw,dR_smooth4,regstr,regfile,date)
...
#
    ...
    painel.drawR0thumb(R0_est_dif_0,R0_est_dif_1,regstr,regfile,date)   
